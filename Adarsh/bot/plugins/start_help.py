    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await b.send_message(
                    chat_id=m.chat.id,
                    text="__Sorry, You Are Banned From Using Me__\n\n  **𝙃𝙚 𝙬𝙞𝙡𝙡 𝙝𝙚𝙡𝙥 𝙮𝙤𝙪**",
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://graph.org/file/2af22b9d619409353804a.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>Someting Went Wrong</i> <b> <a href='https://t.me/nvsmovielink'>CLICK HERE FOR SUPPORT </a></b>",
        ...
        try:
            ...
            if user.status == "kicked":
                await bot.send_message(
                    ...
                    text="<i>Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ FROM USING ᴍᴇ.</i>",
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands</b>\n 〽Powered By:- @tgnvs @nvsmovielink""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ", url="https://t.me/tgnvs")],
                [InlineKeyboardButton("ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ", url="https://t.me/nvsmovielink")]
            ]
        )
    )
